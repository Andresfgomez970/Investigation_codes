...
/* In order to have MAX_STRING_HEADER spaces in an intuitive way two values are
    not really taken into account; that is in name[MAX_STRING_HEADER] \n is 
    saved and in name[MAX_STRING_HEADER + 1] the /0 special character to 
	indicatewhere it finishes. */
#define MAX_STRING_HEADER 100 
